...
export const TEMPLATES: TemplateConfig[] = [
  ...
  {
    id: 'template-scenic-b',
    columnKey: 'B-Scenic',
    name: 'Angkor Blue Horizon',
    badge: 'Scenic',
    planTier: 'Pro Plan',
    badgeType: 'premium',
    description:
      'Full-bleed Angkor Wat photography on the left panel with a deep blue tint, paired with a crisp white content column.',
    primaryColor: '#1d4ed8',
    accentColor: '#3b82f6',
    previewThumbnail: 'scenic-b-thumb',
  },
  {
    id: 'template-scenic-c',
    columnKey: 'C-Scenic',
    name: 'Angkor Golden Temple',
    badge: 'Scenic',
    planTier: 'Pro Plan',
    badgeType: 'premium',
    description:
      'Warm amber-toned temple photography sidebar with golden accents throughout the section headers and skill tags.',
    primaryColor: '#d97706',
    accentColor: '#f59e0b',
    previewThumbnail: 'scenic-c-thumb',
  },
  {
    id: 'template-scenic-d',
    columnKey: 'D-Scenic',
    name: 'Angkor Jungle Ruins',
    badge: 'Scenic',
    planTier: 'Pro Plan',
    badgeType: 'premium',
    description:
      'Jungle-covered temple ruins photography with a fresh green tint, ideal for nature-minded or travel-forward profiles.',
    primaryColor: '#15803d',
    accentColor: '#22c55e',
    previewThumbnail: 'scenic-d-thumb',
  },
  {
    id: 'template-scenic-e',
    columnKey: 'E-Scenic',
    name: 'Angkor Burgundy Stone',
    badge: 'Scenic',
    planTier: 'Pro Plan',
    badgeType: 'premium',
    description:
      'Moody stone-temple photography with a rich burgundy tint for an elegant, executive scenic look.',
    primaryColor: '#9f1239',
    accentColor: '#e11d48',
    previewThumbnail: 'scenic-e-thumb',
  },
  {
    id: 'template-scenic-f',
    columnKey: 'F-Scenic',
    name: 'Angkor Charcoal Ruins',
    badge: 'Scenic',
    planTier: 'Pro Plan',
    badgeType: 'premium',
    description:
      'Dark, dramatic temple-ruin photography with a charcoal tint for a bold, high-contrast scenic design.',
    primaryColor: '#1f2937',
    accentColor: '#4b5563',
    previewThumbnail: 'scenic-f-thumb',
  },
  {
    id: 'template-scenic-g',
    columnKey: 'G-Scenic',
    name: 'Angkor Emerald Canopy',
    badge: 'Scenic',
    planTier: 'Pro Plan',
    badgeType: 'premium',
    description:
      'Lush emerald-green jungle-ruins photography with vivid emerald accents through every section.',
    primaryColor: '#047857',
    accentColor: '#10b981',
    previewThumbnail: 'scenic-g-thumb',
  },
  {
    id: 'template-scenic-h',
    columnKey: 'H-Scenic',
    name: 'Angkor Ancient Roots',
    badge: 'Scenic',
    planTier: 'Pro Plan',
    badgeType: 'premium',
    description:
      'Iconic Ta Prohm tree-root photography with a warm brown tint, for a memorable and distinctive scenic resume.',
    primaryColor: '#78350f',
    accentColor: '#b45309',
    previewThumbnail: 'scenic-h-thumb',
  },
  {
    id: 'template-backdrop-b',
    columnKey: 'B-Backdrop',
    name: 'Faded Blue Backdrop',
    badge: 'Scenic',
    planTier: 'Pro Plan',
    badgeType: 'premium',
    description:
      'Clean two-column layout with a faint, desaturated Angkor Wat watermark behind the whole page and blue accents.',
    primaryColor: '#1d4ed8',
    accentColor: '#3b82f6',
    previewThumbnail: 'backdrop-b-thumb',
  },
  {
    id: 'template-backdrop-c',
    columnKey: 'C-Backdrop',
    name: 'Faded Orange Backdrop',
    badge: 'Scenic',
    planTier: 'Pro Plan',
    badgeType: 'premium',
    description:
      'Clean two-column layout with a faint, desaturated Angkor Wat watermark behind the whole page and orange accents.',
    primaryColor: '#ea580c',
    accentColor: '#f97316',
    previewThumbnail: 'backdrop-c-thumb',
  },
  {
    id: 'template-backdrop-d',
    columnKey: 'D-Backdrop',
    name: 'Faded Peach Backdrop',
    badge: 'Scenic',
    planTier: 'Pro Plan',
    badgeType: 'premium',
    description:
      'Clean two-column layout with a faint, desaturated Angkor Wat watermark behind the whole page and soft peach accents.',
    primaryColor: '#fb923c',
    accentColor: '#fdba74',
    previewThumbnail: 'backdrop-d-thumb',
  },
  {
    id: 'template-backdrop-e',
    columnKey: 'E-Backdrop',
    name: 'Faded Red Backdrop',
    badge: 'Scenic',
    planTier: 'Pro Plan',
    badgeType: 'premium',
    description:
      'Clean two-column layout with a faint, desaturated Angkor Wat watermark behind the whole page and bold red accents.',
    primaryColor: '#dc2626',
    accentColor: '#ef4444',
    previewThumbnail: 'backdrop-e-thumb',
  },
  {
    id: 'template-backdrop-f',
    columnKey: 'F-Backdrop',
    name: 'Faded Crimson Backdrop',
    badge: 'Scenic',
    planTier: 'Pro Plan',
    badgeType: 'premium',
    description:
      'Clean two-column layout with a faint, desaturated Angkor Wat watermark behind the whole page and deep crimson accents.',
    primaryColor: '#b91c1c',
    accentColor: '#dc2626',
    previewThumbnail: 'backdrop-f-thumb',
  },
  {
    id: 'template-backdrop-g',
    columnKey: 'G-Backdrop',
    name: 'Faded Gold Backdrop',
    badge: 'Scenic',
    planTier: 'Pro Plan',
    badgeType: 'premium',
    description:
      'Clean two-column layout with a faint, desaturated Angkor Wat watermark behind the whole page and warm gold accents.',
    primaryColor: '#ca8a04',
    accentColor: '#eab308',
    previewThumbnail: 'backdrop-g-thumb',
  },
  {
    id: 'template-backdrop-h',
    columnKey: 'H-Backdrop',
    name: 'Faded Green Backdrop',
    badge: 'Scenic',
    planTier: 'Pro Plan',
    badgeType: 'premium',
    description:
      'Clean two-column layout with a faint, desaturated Angkor Wat watermark behind the whole page and fresh green accents.',
    primaryColor: '#16a34a',
    accentColor: '#22c55e',
    previewThumbnail: 'backdrop-h-thumb',
  },
];
